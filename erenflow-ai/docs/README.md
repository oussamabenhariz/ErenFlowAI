# ErenFlow AI Documentation

Welcome to the ErenFlowAI documentation! Everything you need to build AI agents is organized here.
...
│   ├── llm/              → Setup OpenAI, Anthropic, Mistral, Groq, etc.
...
| Set up OpenAI, Claude, Mistral, Groq... | [llm/README.md](./llm/README.md) |
...
The following files in the root of `erenflow-ai/` should be removed (they've been moved to `docs/`):
...
**To clean up**, run from the `erenflow-ai` directory:
```bash
...
Multiple LLMs - OpenAI, Anthropic, Mistral, Groq, Azure, Ollama  
